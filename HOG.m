...
% Added by Qi:
% 1. make the prototype of the function as: H=HOG(Im, nwin_x, nwin_y, bin)
function H=HOG(Im)
...
for n=0:nwin_y-1
    for m=0:nwin_x-1
        ...
        % 2. Added by Qi:  This section can be improved using histogram
        % concept (one loop without if)
